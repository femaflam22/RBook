...
<div class="edit-wrap px-5">
    <div class="d-flex justify-content-between mb-3">  
        <router-link v-bind:to="{name: 'write_book.detail', params: {id: this.$route.params.id}}">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-orange text-white mt-2" @click.prevent="add">Simpan</button>
                    <div id="content"></div>
                </div>
            </div>
        </div>
    ...
    data() {
        return {
            data: {
                ...
                chapter: this.$route.params.part,
                name: '',
                content: ''
            },
